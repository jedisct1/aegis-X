...
The mode presented here also encrypts multiple messages simultaneously using the same cipher, but assumes that they are derived from a common message, and share the same key, initialization vector and length.
...
Differential attacks are a major concern with the same $(K, IV)$ pair used in different contexts.
